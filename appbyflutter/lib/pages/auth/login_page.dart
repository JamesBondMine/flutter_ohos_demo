...
// 协议勾选
  Widget _buildProtocol() {
    return SafeArea(
      ...
      onTap: () {},
      child: Padding(padding: EdgeInsetsGeometry.only(right: 24), child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          InkWell(
            onTap: () {
              ...
              text: const TextSpan(
                ...
                children: [
                  TextSpan(
                      text: '我已阅读并同意',
                      style:
                          TextStyle(fontSize: 20, color: GbsColors.textColor6)),
                  TextSpan(
                    text: '《用户注册协议》',
                    style:
                        TextStyle(fontSize: 20, color: GbsColors.primaryColor),
                  ),
                  TextSpan(text: ' '),
                  TextSpan(
                    text: '《隐私政策》',
