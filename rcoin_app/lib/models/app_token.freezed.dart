...
class _$AppTokenImpl implements _AppToken {
  const _$AppTokenImpl({this.token = '', this.expiresAt = 0});
  ...
  @override
  String toString() {
    return 'AppToken(token: $token, expiresAt: $expiresAt)';
  }
...
abstract class _AppToken implements AppToken {
  const factory _AppToken({final String token, final int expiresAt}) =
      _$AppTokenImpl;
