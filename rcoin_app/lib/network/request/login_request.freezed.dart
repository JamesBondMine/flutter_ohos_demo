...
abstract class $LoginRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String? account, String? captcha, int? loginType, String? password});
}
...
class _$LoginRequestImpl with DiagnosticableTreeMixin implements _LoginRequest {
  const _$LoginRequestImpl(
      {this.account, this.captcha, this.loginType, this.password});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LoginRequest(account: $account, captcha: $captcha, loginType: $loginType, password: $password)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, account, captcha, loginType, password);
