...
abstract class _$$PagingRequestImplCopyWith<$Res>
  ...
  factory _$$PagingRequestImplCopyWith(
          _$PagingRequestImpl value, $Res Function(_$PagingRequestImpl) then) =
...
class __$$PagingRequestImplCopyWithImpl<$Res>
  ...
  __$$PagingRequestImplCopyWithImpl(
      _$PagingRequestImpl _value, $Res Function(_$PagingRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PagingRequestImpl(
      page: freezed == page
          ? _value.page
          : page // ignore: cast_nullable_to_non_nullable
              as int?,
...
class _$PagingRequestImpl implements _PagingRequest {
  const _$PagingRequestImpl({this.page, this.pageSize});
  ...
  @override
  String toString() {
    return 'PagingRequest(page: $page, pageSize: $pageSize)';
  }
...
abstract class _PagingRequest implements PagingRequest {
  const factory _PagingRequest({final int? page, final int? pageSize}) =
      _$PagingRequestImpl;
