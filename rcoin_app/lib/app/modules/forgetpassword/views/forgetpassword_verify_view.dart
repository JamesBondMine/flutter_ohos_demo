...
import 'package:otc_app/app/modules/forgetpassword/controllers/forgetpassword_controller.dart';
...
class ForgetpasswordVerifyView extends GetView<ForgetpasswordController> {
  const ForgetpasswordVerifyView({Key? key}) : super(key: key);
  @override
        ...
        child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      padding: EdgeInsets.only(
                          left: 20.w, right: 20.w, bottom: 40.w),
                      child: Text(
          ...
          Obx(() => controller.showPassword1.value
              ? _inputWrap(LoginTextField(
                  ...
                  suffixIcon: Padding(
                    ...
                    child: IconButton(
                      icon: ImageIcon(AssetImage(Assets.loginLoginTextfieldEye),
                          color: Config.kTheme!.text1, size: 18),
                      onPressed: () {
          ...
          Obx(
            () => controller.showPassword.value
                ? _inputWrap(LoginTextField(
                    controller: controller.reconfirmPasswordCtrl,
                    prefixIcon: Padding(
                ...
                : _inputWrap(LoginTextField(
                    controller: controller.reconfirmPasswordCtrl,
                    prefixIcon: _inputIcon(), // Assets.loginLoginTextfieldLock,
                    suffixIcon: Padding(
                      padding:
                          EdgeInsetsDirectional.only(start: 20.w, end: 10.w),
                      child: IconButton(
