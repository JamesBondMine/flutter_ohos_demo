...
class SaleOrdersController extends GetxController
    with PagingMixin<PublishOrder> {
  Timer? timer;
  static SaleOrdersController get to => Get.put(SaleOrdersController());
  ...
  void onReady() {
    ...
    timer = Timer.periodic(const Duration(seconds: 2), (timer) async {
      if (ApplicationController.to.currentRoute == Routes.TRADE &&
          ...
          Get.find<TradeController>().tabController.index == 1) {
