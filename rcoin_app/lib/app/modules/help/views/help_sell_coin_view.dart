...
class HelpSellCoinView extends GetView<HelpController> {
  const HelpSellCoinView({Key? key}) : super(key: key);
  @override
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    ...
                    // _card(Assets.helpStep1, Assets.helpSel1, 376.w,
                    //     _cellHeaderView()),
                    // _card(Assets.helpStep2, Assets.helpSel2, 376.w,
                    //     _cellHeaderView2()),
                    // _card(
                    //     Assets.helpStep3,
                    //     Assets.helpSel3,
                    //     Get.locale!.languageCode == 'en' ? 412.w : 382.w,
                    //     _cellHeaderView3()),
                    // _card(Assets.helpStep4, Assets.helpSel4, 486.w,
                    //     _cellHeaderView4())
                  ],
                ),
              ))
