...
class WalletTransferPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return WalletTransferPageState();
  }
}

class WalletTransferPageState extends State<WalletTransferPage> {
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(
                bottom: 28.0, left: 15, right: 15, top: 30),
            child: AppButton(
              height: 52.w,
              width: 334.w,
              onPressed: () {
                TransferController.to.transfer(
                    inputController.text, _equivalentQuantity.text, () {
                  _equivalentQuantity.text = "";
                  _equivalentQuantity.text = "";
                });
              },
              title: '确定'.tr,
    ...
    return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
            ...
            child: TextField(
              controller: _equivalentQuantity,
              keyboardType: TextInputType.number,
              inputFormatters: [
                positiveNumberFormatter,
              ],
              onChanged: (value) async {
                double number = double.tryParse(value.trim()) ?? 0;

                double fee = await TransferController.to.transferFee(number);
                setState(() {
                  feeStr = (fee > 0 ? fee : '-').toString();
                  equivalentAmount = number;
                });
              },
              style: TextStyle(fontSize: 16.sp, color: Config.kTheme!.text1),
              ...
              return Wrap(
                ...
                children: List.generate(
                  ...
                  (index) => GestureDetector(
                    onTap: () async {
                      _equivalentQuantity.text = options[index].toString();

                      double number =
                          double.tryParse(_equivalentQuantity.text.trim()) ?? 0;

                      double fee =
                          await TransferController.to.transferFee(number);
                      setState(() {
                        feeStr = (fee > 0 ? fee : '-').toString();
                        equivalentAmount = number;
                      });
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(8),
                          color: Color(0xffB9EEFF).withOpacity(0.5)),
                      height: 44.w,
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: outlineInputDecoration.copyWith(
                        ...
                        hintStyle: TextStyle(
                            color: Config.kTheme!.text1, fontSize: 13.sp),
