...
import 'package:otc_app/common/refresh/refresh_footer.dart';
...
class PullRefreshControl extends StatelessWidget {
  ...
  final ERChildBuilder? emptyWidgetBuilder;
  ...
  Widget build(BuildContext context) {
    ...
    return EasyRefresh.builder(
      ...
      footer: footer ?? const RefreshFooter(),
        ...
        return ValueListenableBuilder(
          ...
          builder: (context, value, child) {
            if (value.isStartEmpty) {
              ...
              return emptyWidgetBuilder != null
